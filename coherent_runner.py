...
def coherent_eval(mass_arr,det_switch="LAr",coherent="true",channels={_pion_decay,_piminus_cap},signal_channel="NCE_nucleon",alpha_D=0.5,sumlog="Events/coherent_y.dat"):
    ...
    if MX/1000.0<mpi0/2.0 and MV<600.0 and _pion_decay in channels:
        ...
        executing = True
    if MX/1000.0<0.129/2.0 and MV<600 and _piminus_cap in channels:
        proddist.append("")
    ...
    if signal_channel=="NCE_nucleon":
        ...
        write_coherent(mdm=MX/1000.0,mv=MV/1000.0,proddist=proddist,\
                prod_chan=prodchan,\
                partlistfile=partlistfile,outfile=parfile,samplesize=2000,\
...
def execute_coherent(genlist=True):
    ...
    for marr in massarr:
        coherent_eval(marr,signal_channel="NCE_nucleon",sumlog="Events/coherent_LAr.dat",coherent="true")
        coherent_eval(marr,signal_channel="NCE_nucleon",sumlog="Events/coherent_NaI.dat",coherent="true")
