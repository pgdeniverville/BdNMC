...
def ship_eval(mass_arr,signal_channel="NCE_electron"):
    ...
    if signal_channel =="NCE_electron":
        #write_ship(mdm=MX/1000.0,mv=MV/1000.0,proddist=proddist,prod_chan=prodchan,partlistfile=partlistfile,outfile=parfile,signal_chan="NCE_electron",samplesize=100000,sumlog="Events/ship_y_andrei2.dat",output_mode="summary",alpha_D=alD)
        write_ship(mdm=MX/1000.0,mv=MV/1000.0,proddist=proddist,prod_chan=prodchan,partlistfile=partlistfile,outfile=parfile,signal_chan="NCE_electron",samplesize=1e6,sumlog="Events/ship_test.dat",output_mode="comprehensive",outlog="Events/andrei_events.dat",alpha_D=alD)
