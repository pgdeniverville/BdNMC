...
def execute_lanl(genlist=True):
    ...
    for marr in massarr:
        ...
        d={"POT" : 2.25e22,"mv" : marr[0], "alpha_D" : 0.5, "eps" : 1e-3, "efficiency" : CCM_EFFICIENCY, "mdm" : marr[1], "channels" : [_pion_decay], "signal_chan" : "NCE_electron", "det_switch" : "lanl", "samplesize" : 2000, "sumlog" : "CCM_Events/CCM_electron5mev.dat", "outlog" : "CCM_Events/CCM_electron_{}".format(str(marr[0])),"model" : "Dark_Photon",  "min_scatter_energy" : 0.005, "max_scatter_energy" : 1, "burn_max" : 1000, "output_mode" : "summary", "pi0_per_POT" : 0.1145}
        ...
        lanl_eval(d)
        d={"POT" : 2.25e22,"mv" : marr[0], "alpha_D" : 0.5, "eps" : 1e-3, "efficiency" : CCM_EFFICIENCY, "mdm" : marr[1], "channels" : [_pion_decay], "signal_chan" : "NCE_electron", "det_switch" : "lanl", "samplesize" : 2000, "sumlog" : "CCM_Events/CCM_electron1mev.dat", "outlog" : "CCM_Events/CCM_electron_{}".format(str(marr[0])),"model" : "Dark_Photon",  "min_scatter_energy" : 0.001, "max_scatter_energy" : 1, "burn_max" : 1000, "output_mode" : "summary", "pi0_per_POT" : 0.1145}
        lanl_eval(d)
        d={"POT" : 2.25e22,"mv" : marr[0], "alpha_D" : 0.5, "eps" : 1e-3, "efficiency" : CCM_EFFICIENCY, "mdm" : marr[1], "channels" : [_pion_decay], "signal_chan" : "NCE_electron", "det_switch" : "lanl", "samplesize" : 2000, "sumlog" : "CCM_Events/CCM_electron10mev.dat", "outlog" : "CCM_Events/CCM_electron_{}".format(str(marr[0])),"model" : "Dark_Photon",  "min_scatter_energy" : 0.01, "max_scatter_energy" : 1, "burn_max" : 1000, "output_mode" : "summary", "pi0_per_POT" : 0.1145}
        lanl_eval(d)
