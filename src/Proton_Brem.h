...
class Proton_Brem : public DMgenerator{
    ...
    public:
        Proton_Brem(double Beam_E, std::function<double(double, double)> splitting_function, double m_mediator, double ptmax, double zmax, double zmin, std::string &mode, std::shared_ptr<DMgenerator> V_decay, double ptmin=0);
    ...
    private:
        ...
        double Beam_Energy, PTMIN, PTMAX, ZMAX, ZMIN, MA;
